...
class Controller:
    ...
    def __init__(self):
        ...
        self.__event_handlers: dict = {
            ...
            ControlEventType.KB_RELEASE_GAS: lambda data: self.__vehicle.change_throttle(-1),
            ControlEventType.KB_BRAKE: lambda data: self.__vehicle.kb_set_brake(1),
            ControlEventType.KB_RELEASE_BRAKE: lambda data: self.__vehicle.kb_set_brake(0),
            ControlEventType.KB_LEFT: lambda data: self.__vehicle.kb_set_steer(-1),
            ControlEventType.KB_RIGHT: lambda data: self.__vehicle.kb_set_steer(1),
            ControlEventType.KB_CENTER_WHEEL: lambda data: self.__vehicle.kb_set_steer(0),
