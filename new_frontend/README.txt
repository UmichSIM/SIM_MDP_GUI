...
### TODO:   
1. DONE -- Figure out how to get the images back 
...
4. DONE -- Add and connected remaining screens.
5. TODO -- Have widgets load values currently in config.py when changing screens. -- (do we need this??????)
6. TODO -- Split the different screen classes in ConnectedScreens to different files.
7. TODO -- Save and Load Config.py to and from a saved file. (optional...)
...
10. DONE --  Design and generate popup screens (add vehicle, edit traffic light setting)
### 