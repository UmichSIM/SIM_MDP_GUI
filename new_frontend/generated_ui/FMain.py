...
class Ui_FullDisplay(object):
    def setupUi(self, FullDisplay):
        ...
        self.GeneralFreewaySettings_title.setGeometry(QtCore.QRect(400, 20, 581, 61))
        font = QtGui.QFont()
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 180, 341, 81))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 270, 361, 361))
        ...
        self.SafetyDist_txt.setScaledContents(False)
    ...
    def retranslateUi(self, FullDisplay):
        ...
        self.GeneralFreewaySettings_title.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:48pt;\">General Freeway Settings</span></p></body></html>"))
        self.AllowCollisions_txt.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:30pt;\">Allow Collisions</span></p></body></html>"))
        ...
        self.NumFwaySections_txt.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:30pt;\"># of Freeway Sections</span></p></body></html>"))
        self.MaxSpeed_txt.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:30pt;\">Maximum Speed (m/s)</span></p></body></html>"))
        self.MinSpeed_txt.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:30pt;\">Minimum Speed (m/s)</span></p></body></html>"))
        self.SafetyDist_txt.setText(_translate("FullDisplay", "<html><head/><body><p><span style=\" font-size:30pt;\">Safety Distance (m)</span></p></body></html>"))
