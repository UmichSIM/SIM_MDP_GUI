# Form implementation generated from reading ui file 'editSingleVehicleIntsctn.ui'
#
...
class Ui_EditSingleVehicleInsctn(object):
    def setupUi(self, EditSingleVehicleInsctn):
        ...
        self.EditSingularVehicleTitle_txt = QtWidgets.QLabel(EditSingleVehicleInsctn)
        ...
        self.Back_bttn = QtWidgets.QPushButton(EditSingleVehicleInsctn)
        ...
        self.CarTitle_txt = QtWidgets.QLabel(EditSingleVehicleInsctn)
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(EditSingleVehicleInsctn)
        ...
        self.Turn_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.Turn_txt.setFont(font)
        self.Turn_txt.setObjectName("Turn_txt")
        self.Turn_layout.addWidget(self.Turn_txt)
        self.Turn_dropbx = QtWidgets.QComboBox(self.verticalLayoutWidget)
        ...
        self.Stop_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.Stop_txt.setFont(font)
        self.Stop_txt.setObjectName("Stop_txt")
        self.Stop_layout.addWidget(self.Stop_txt)
        self.Stop_dropbox = QtWidgets.QComboBox(self.verticalLayoutWidget)
        ...
        self.VehicleModel_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.VehicleModel_dropbx = QtWidgets.QComboBox(self.verticalLayoutWidget)
        ...
        self.Color_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        ...
        self.RValue_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.RValue_txt.setFont(font)
        self.RValue_txt.setObjectName("RValue_txt")
        self.Color_layout.addWidget(self.RValue_txt)
        self.RValue_inptbx = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        ...
        self.GValue_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.GValue_txt.setFont(font)
        self.GValue_txt.setObjectName("GValue_txt")
        self.Color_layout.addWidget(self.GValue_txt)
        self.GValue_inptbx = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        ...
        self.BValue_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.BValue_txt.setFont(font)
        self.BValue_txt.setObjectName("BValue_txt")
        self.Color_layout.addWidget(self.BValue_txt)
        self.BValue_inptbx = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        ...
        self.Gap_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.Gap_txt.setFont(font)
        self.Gap_txt.setObjectName("Gap_txt")
        self.Gap_layout.addWidget(self.Gap_txt)
        self.Gap_spinbx = QtWidgets.QSpinBox(self.verticalLayoutWidget)
        ...
        self.YTrafficLight_txt = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.YTrafficLight_chkbx = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        ...
        self.Intersection_img = QtWidgets.QLabel(EditSingleVehicleInsctn)
        self.Intersection_img.setGeometry(QtCore.QRect(750, 130, 501, 611))
        self.Intersection_img.setObjectName("Intersection_img")
        self.horizontalLayoutWidget_8 = QtWidgets.QWidget(EditSingleVehicleInsctn)
        ...
        self.DeleteVehicle_bttn = QtWidgets.QPushButton(self.horizontalLayoutWidget_8)
        ...
        self.CancelEdit_bttn = QtWidgets.QPushButton(self.horizontalLayoutWidget_8)
        ...
        self.ConfirmChange_bttn = QtWidgets.QPushButton(self.horizontalLayoutWidget_8)
    ...
    def retranslateUi(self, EditSingleVehicleInsctn):
        ...
        self.Intersection_img.setText(_translate("EditSingleVehicleInsctn", "<html><head/><body><p><img src=\":/intersection/images/intersection.jpg\" width=\"500\"/></p></body></html>"))
