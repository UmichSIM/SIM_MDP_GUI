"""
Carla Modules - CameraManager class
...
#camera view
        ...
        if not self._parent.type_id.startswith("walker.pedestrian"):
            self._camera_transforms = [
                ...
                (carla.Transform(carla.Location(x=0.05*bound_x, y=-0.26*bound_y,z=1.02*bound_z)), Attachment.Rigid),
                (carla.Transform(carla.Location(x=-10*bound_x, y=0*bound_y,z=10*bound_z), carla.Rotation(pitch=10.0)), Attachment.SpringArm)
