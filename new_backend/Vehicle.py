...
class Vehicle:
    ...
    def draw_waypoints(self, world: carla.World) -> None:
        ...
        for i in range(len(self.waypoints) - 1):
            world.debug.draw_point(self.waypoints[i].transform.location, size=0.15, color=ORANGE, life_time=0.0)

        world.debug.draw_point(self.waypoints[-1].transform.location, size=0.15, color=RED, life_time=0.0)
